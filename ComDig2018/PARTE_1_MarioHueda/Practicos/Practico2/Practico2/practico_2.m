...
%==========================================================
% Diagrama de ojo de la parte real
%==========================================================
 
yn_real=real(yn_hat)
eyediagram(yn_real(1:1000),8)
title('Diagrama de ojo PARTE REAL')
xlabel('')
ylabel('')
 
%==========================================================% Diagrama de ojo de la parte imaginaria
% Diagrama de ojo de la parte imaginaria
%==========================================================
 
 
yn_imag=imag(yn_hat)
eyediagram(yn_imag(1:1000),8)
title('Diagrama de ojo PARTE IMAGINARIA')
xlabel('')
ylabel('')
